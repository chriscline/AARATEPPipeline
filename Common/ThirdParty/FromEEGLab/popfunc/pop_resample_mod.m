...
function [EEG, command] = pop_resample_mod( EEG, freq, fc, df); 
...
if isfield(EEG.event, 'latency')
    ...
    if EEG.trials > 1 % Epoched data; not recommended
        ...
        warning('EEGLab:ResamplingEpochedData','Resampling of epoched data is not recommended (due to anti-aliasing filtering)!'); 
